...
function work(req,res){
    ...
    req.on("end", function (){
        logger.debug('收到客户端发来的数据:  ', String(crypt.decrypt(Buffer.concat(chunks, size), "it\'s raining outside and I do miss you")).replace(/^return\s+/, ""));
        new Promise(function (resolve, reject) {
            ...
            logger.debug('rpc 返回给客户端的结果', ...args);
